...
# (rättat 2026-09-20, se PROJECT_SPEC.md §19 i robot-control-repot — var
# tidigare `sleep 10`, matchade inte de 90s som faktiskt löste
# startproblemen med RControlStation)
sleep 90
